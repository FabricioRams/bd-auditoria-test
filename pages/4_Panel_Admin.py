...
st.set_page_config(page_title="Panel de Administración SaaS", layout="wide")
...
if st.session_state.get("rol") != "admin":
    st.error("🚫 Acceso denegado. Esta página es exclusiva para administradores del SaaS.")
    st.stop()

st.title("🛡️ Panel de Administración SaaS")
...
def get_admin_data():
    ...
    conn.close()
    return df_usuarios, df_accesos

df_usuarios, df_accesos = get_admin_data()
